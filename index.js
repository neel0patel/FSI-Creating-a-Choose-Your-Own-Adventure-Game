...
if (firstAnswer === "left") {
  ...
  if (secondAnswer === "Follow") {
    ...
    const continueAnswer = window.prompt(
  ...
  if (secondAnswer === "Past the dragon") {
    ...
    } // Away from dragon case
  } else if (secondAnswer === "Away from the dragon") {
    const thirdAnswer = window.prompt(
